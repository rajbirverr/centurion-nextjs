      ...
      >
        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex items-center space-x-3" style={{ overflow: 'visible' }}>
            ...
            >
              <span className="mr-1 relative z-10">Filter</span>
              {activeFilterCount > 0 && (
                <span className="bg-[#403b38] text-white text-xs rounded-full w-5 h-5 flex items-center justify-center relative z-10">
                  {activeFilterCount}
                </span>
              )}
            </button>
